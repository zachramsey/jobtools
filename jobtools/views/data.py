...
class JobDetails(QDialog):
    ...
    def __init__(self, job_data: dict, parent=None):
        ...
        # Job Source Links
        source = QHBoxLayout()
        site_str = job_data.get("site", "Job Board").capitalize()
        ...
        # Job Title
        title_label = QLabel(f"<b>{job_data.get('title', 'Unknown Job Title')}</b>")
        ...
        location_label = QLabel(job_data.get("state", "Unknown Location"))
        ...
        description_md = clean_description(job_data.get("description", "No description available."))
        description_view = QTextEdit(markdown=description_md)
